...
class HTMLHelp:
    ...
    def helpPages(self):
        ...
        """.strip()
        self.page_UniDec_info = {"msg": msg, "title": "About UniDec...", "window_size": (550, 300)}
        ...
        """.strip()
        self.page_data_loading_info = {"msg": msg, "title": "Learn about: Loading data", "window_size": (1250, 800)}
