...
class PeptideAnnotation:
    def __init__(self, **kwargs):
        ...
        self._M_all_ = ["M", "M-H2Ox1", "M-H2Ox2", "M-H2Ox3", "M-H2Ox4", "M-NH3x1", "M-NH3x2", "M-NH3x3", "M-NH3x4"]
        self._a_all_ = ["a", "a-H2Ox1", "a-H2Ox2", "a-H2Ox3", "a-H2Ox4", "a-NH3x1", "a-NH3x2", "a-NH3x3", "a-NH3x4"]
        self._b_all_ = ["b", "b-H2Ox1", "b-H2Ox2", "b-H2Ox3", "b-H2Ox4", "b-NH3x1", "b-NH3x2", "b-NH3x3", "b-NH3x4"]
        self._c_all_ = [
            "c",
            "c-H2Ox1",
            "c-H2Ox2",
        ...
        self._x_all_ = ["x", "x-H2Ox1", "x-H2Ox2", "x-H2Ox3", "x-H2Ox4", "x-NH3x1", "x-NH3x2", "x-NH3x3", "x-NH3x4"]
        self._y_all_ = ["y", "y-H2Ox1", "y-H2Ox2", "y-H2Ox3", "y-H2Ox4", "y-NH3x1", "y-NH3x2", "y-NH3x3", "y-NH3x4"]
        self._z_all_ = [
            "z",
            "z-H2Ox1",
            "z-H2Ox2",
    ...
    def check_peptide_rules(self, ion_type, peptide):
        ...
        if ion_type in self._all_h2o_loss_:
            if re.search("[STED]", peptide):
                ...
                if "x1" in ion_type and aa_count >= 1:
                    return True
                elif "x2" in ion_type and aa_count >= 2:
                    return True
                elif "x3" in ion_type and aa_count >= 3:
                    return True
                elif "x4" in ion_type and aa_count >= 4:
                    return True
                else:
                    return False
    ...
    def generate_fragments_from_peptide(
        self,
        peptide,
        ion_types,
        label_format={},
        ...
        for ion_type in ion_types:
            if ion_type in [self._M_all_]:
                ...
                for charge in range(min_charge, max_charge + 1):
                    ion_mz = mass.fast_mass(peptide, ion_type=ion_type, charge=charge, ion_comp=ion_composition)
            ...
            if ion_type in self._all_abc_all_:
                ...
                for i in range(1, len(peptide)):
                    ...
                    for charge in range(min_charge, max_charge + 1):
                        ion_mz = mass.fast_mass(peptide_seq, ion_type=ion_type, charge=charge, ion_comp=ion_composition)
    ...
    def generate_label(self, frag_name, idx, polarity, charge, sequence, full_ion_type=None, **kwargs):
        """
