...
class UniDecConfig(object):
    ...
    def write_hdf5(self, file_name=None):
        ...
        cdict = {  # "input": self.infname, "output": self.outfname,
            ...
            "mzsig": self.mzsig,
            "psfun": self.psfun,
            "discreteplot": self.discreteplot,
            "massub": self.massub,
            "masslb": self.masslb,
            "msig": self.msig,
            "molig": self.molig,
            "massbins": self.massbins,
            "mtabsig": self.mtabsig,
            "minmz": self.minmz,
            "maxmz": self.maxmz,
            "subbuff": self.subbuff,
            "smooth": self.smooth,
            "mzbins": self.mzbins,
            "peakwindow": self.peakwindow,
            "peakthresh": self.peakthresh,
            "peakplotthresh": self.peakplotthresh,
            "plotsep": self.separation,
            "intthresh": self.intthresh,
            "aggressive": self.aggressiveflag,
            "rawflag": self.rawflag,
            "adductmass": self.adductmass,
            "nativezub": self.nativezub,
            "nativezlb": self.nativezlb,
            "poolflag": self.poolflag,
            "accvol": self.detectoreffva,
            "peakshapeinflate": self.inflate,
            "noiseflag": self.noiseflag,
            "linflag": self.linflag,
            "cmap": self.cmap,
            "peakcmap": self.peakcmap,
            "publicationmode": self.publicationmode,
            "isotopemode": self.isotopemode,
            "peaknorm": self.peaknorm,
            "baselineflag": self.baselineflag,
            "orbimode": self.orbimode,
            "zout": self.zout,
            "pusher": self.pusher,
            "mindt": self.mindt,
            "maxdt": self.maxdt,
            ...
            "dtsig": self.dtsig,
            "csig": self.csig,
            "ccsbins": self.ccsbins,
            "subbufdt": self.subbufdt,
            "smoothdt": self.smoothdt,
            "ubnativeccs": self.nativeccsub,
            "lbnativeccs": self.nativeccslb,
            "twaveflag": self.twaveflag,
            "temp": self.temp,
            "pressure": self.pressure,
            "volt": self.volt,
            "tnaught": self.to,
            "driftlength": self.driftlength,
            "tcal1": self.tcal1,
            "tcal2": self.tcal2,
            "edc": self.edc,
            "gasmass": self.gasmass,
            "integratelb": self.integratelb,
            "integrateub": self.integrateub,
            "filterwidth": self.filterwidth,
            "zerolog": self.zerolog,
            "manualfileflag": self.manualfileflag,
            "mfileflag": self.mfileflag,
            "imflag": self.imflag,
            "exwindow": self.exwindow,
    ...
    def check_badness(self):
        ...
        if self.imflag == 1:
            if self.nativeccsub <= self.nativeccslb:
                self.warning = (
                    "Max native ccs offset is less or equal to Min native ccs offset" "\nFix native ccs offset range."
                )
                self.badtest = 1
            ...
            if self.twaveflag > 0 and (self.tcal1 == 0 or self.tcal2 == 0 or self.edc == 0):
                self.warning = (
                    "Note: One or more T-wave calibration parameters has been set to 0"
