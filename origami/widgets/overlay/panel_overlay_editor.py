...
class PanelOverlayEditor(MiniFrame, TableMixin, ColorGetterMixin, PanelOverlayViewerMixin):
    ...
    def on_close(self, evt, force: bool = False):
        ...
        super(PanelOverlayEditor, self).on_close(evt, force)
    ...
    def make_side_panel(self, split_panel):
        ...
        # make settings
        self.notebook = self.make_settings_panel(panel)
...
def _main():
    ...
    app = wx.App()
    ex = PanelOverlayEditor(None, None, item_list=item_list, debug=True)
