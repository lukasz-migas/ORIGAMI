...
class PanelManualImportDataset(PanelImportManagerBase):
    ...
    def get_parameters_implementation(self):
        ...
        return dict(activation_type=activation_type)
