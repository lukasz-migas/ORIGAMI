...
class panelParametersEdit(wx.Panel):
    ...
    def make_gui(self):
        ...
        self.mainBook.AddPage(self.make_panelGeneral(self.settings_general), "General", False)

        # plot 1D
        self.settings_plot1D = wx.Panel(
            self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL | wx.NB_MULTILINE
        )
        self.mainBook.AddPage(self.make1DparametersPanel(self.settings_plot1D), "Plot 1D", False)

        # plot 2D
        self.settings_plot2D = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.make2DparametersPanel(self.settings_plot2D), "Plot 2D", False)

        # plot 3D
        self.settings_plot3D = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        ...
        # legend
        self.settings_legend = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.makeLegendPanel(self.settings_legend), "Legend", False)

        # rmsd
        self.settings_rmsd = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.make_panelRMSD(self.settings_rmsd), "RMSD", False)

        # waterfall
        self.settings_waterfall = wx.Panel(
            self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL
        )
        self.mainBook.AddPage(self.make_panelWaterfall(self.settings_waterfall), "Waterfall", False)

        # violin
        self.settings_violin = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.make_panelViolin(self.settings_violin), "Violin", False)

        # plot sizes
        self.settings_extra = wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.make_panelExtra(self.settings_extra), "Extra", False)
    ...
    def make_panelGeneral(self, panel):
        PANEL_SPACE_MAIN = 2
        axisParameters_staticBox = makeStaticBox(panel, "Axis parameters", size=(-1, -1), color=wx.BLACK)
        ...
        fontParameters_staticBox = makeStaticBox(panel, "Font parameters", size=(-1, -1), color=wx.BLACK)
    ...
    def make_panelExtra(self, panel):
        ...
        self.general_style_value = wx.Choice(panel, -1, choices=self.config.styles, size=(-1, -1))
        ...
        self.general_palette_value = BitmapComboBox(panel, -1, choices=[], size=(160, -1), style=wx.CB_READONLY)
        ...
        _general_multiThreading_check = makeSuperTip(
            self.general_multiThreading_check, **self.help.general_multiThreading
        )
        ...
        self.general_autoSaveSettings_check = makeCheckbox(
            panel, "Auto-save settings", ID=ID_extraSettings_autoSaveSettings
        )
        ...
        _general_autoSaveSettings_check = makeSuperTip(
            self.general_autoSaveSettings_check, **self.help.general_autoSaveSettings
        )
    ...
    def make_panelRMSD(self, panel):
        ...
        self.rmsd_lineStyle_value = wx.Choice(panel, -1, choices=self.config.lineStylesList, size=(-1, -1), name="rmsf")
    ...
    def make1DparametersPanel(self, panel):
        ...
        # make elements
        lineParameters_staticBox = makeStaticBox(panel, "Line parameters", size=(-1, -1), color=wx.BLACK)
        ...
        self.plot1D_lineStyle_value = wx.Choice(panel, -1, choices=self.config.lineStylesList, size=(-1, -1))
        ...
        markerParameters_staticBox = makeStaticBox(panel, "Marker parameters", size=(-1, -1), color=wx.BLACK)
        ...
        barParameters_staticBox = makeStaticBox(panel, "Bar parameters", size=(-1, -1), color=wx.BLACK)
        ...
        # Replot button
        self.update1DBtn = wx.Button(panel, wx.ID_ANY, "Update", wx.DefaultPosition, wx.Size(-1, -1), 0)
        self.update1DBtn.Bind(wx.EVT_BUTTON, self.onUpdate1D)

        self.plot1DBtn = wx.Button(panel, wx.ID_ANY, "Replot", wx.DefaultPosition, wx.Size(-1, -1), 0)
    ...
    def make2DparametersPanel(self, panel):
        ...
        # make elements
        plot2D_staticBox = makeStaticBox(panel, "Plot 2D parameters", size=(-1, -1), color=wx.BLACK)
        ...
        self.plot2D_plotType_value = wx.Choice(panel, -1, choices=self.config.imageType2D, size=(-1, -1))
    ...
    def make3DparametersPanel(self, panel):
        ...
        # make elements
        plot3D_staticBox = makeStaticBox(panel, "Plot 3D parameters", size=(-1, -1), color=wx.BLACK)
        ...
        scatter3D_staticBox = makeStaticBox(panel, "Scatter 3D parameters", size=(-1, -1), color=wx.BLACK)
