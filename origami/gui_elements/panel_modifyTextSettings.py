...
class panelModifyTextSettings(MiniFrame):
    """
    ...
    def make_panel(self):
        ...
        self.text_charge_value = wx.TextCtrl(panel, -1, "", size=(-1, -1), validator=validator("intPos"))
        ...
        self.text_colormap_value = wx.Choice(panel, -1, choices=self.config.cmaps2, size=(-1, -1))
        ...
        self.text_color_value = wx.Button(panel, wx.ID_ANY, "", wx.DefaultPosition, wx.Size(26, 26), 0)
        ...
        grid.Add(self.text_select_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        ...
        grid.Add(self.text_charge_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        grid.Add(min_threshold_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_min_threshold_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        grid.Add(max_threshold_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_max_threshold_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        grid.Add(colormap_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_colormap_value, (n, 1), flag=wx.EXPAND)
        grid.Add(self.text_restrictColormap_value, (n, 2), flag=wx.ALIGN_LEFT | wx.ALIGN_CENTER_VERTICAL)
        n = n + 1
        grid.Add(color_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_color_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        grid.Add(mask_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_mask_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
        grid.Add(transparency_label, (n, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.text_transparency_value, (n, 1), flag=wx.EXPAND)
        n = n + 1
    ...
    def on_apply(self, evt):
        ...
        self.parent.peaklist.SetStringItem(
            self.itemInfo["id"], self.config.textlistColNames["charge"], self.text_charge_value.GetValue()
        )
        self.parent.peaklist.SetStringItem(
            self.itemInfo["id"], self.config.textlistColNames["colormap"], self.text_colormap_value.GetStringSelection()
        )
        self.parent.peaklist.SetStringItem(
            self.itemInfo["id"], self.config.textlistColNames["mask"], num2str(self.text_mask_value.GetValue())
        )
        self.parent.peaklist.SetStringItem(
            self.itemInfo["id"], self.config.textlistColNames["alpha"], num2str(self.text_transparency_value.GetValue())
        )
        self.parent.peaklist.SetStringItem(
            self.itemInfo["id"], self.config.textlistColNames["label"], self.text_label_value.GetValue()
        )
    ...
    def on_restrict_colormaps(self, evt):
        ...
        self.text_colormap_value.SetItems(cmap_list)
