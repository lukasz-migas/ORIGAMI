...
class panelSequenceAnalysis(wx.MiniFrame):
    ...
    def __init__(self, parent, presenter, config, icons):
        wx.MiniFrame.__init__(
            self, parent, -1, 'Sequence analysis...', size=(-1, -1),
    ...
    def make_panel(self):
        ...
        info_grid.Add(
            vertical_line_2, (y, 5), wx.GBSpan(1, 1),
        ...
        info_grid.Add(
            self.minCCS_value, (y, 1), wx.GBSpan(1, 1),
        ...
        info_grid.Add(
            self.maxCCS_value, (y, 4), wx.GBSpan(1, 1),
            flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_LEFT,
        )
