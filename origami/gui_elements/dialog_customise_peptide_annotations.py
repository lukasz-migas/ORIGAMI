...
class DialogCustomisePeptideAnnotations(Dialog):
    ...
    def make_panel(self):
        ...
        self.arrow_line_style_value = wx.Choice(
            panel, -1,
        ...
        self.label_fontSize_value = wx.Choice(
            panel, -1,
        ...
        self.label_fontWeight_value = wx.Choice(
            panel, -1,
        ...
        label_grid.Add(
            self.label_show_peptide_check, (y, 2), wx.GBSpan(
                1, 1,
            ), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        ...
        y = y + 1
        grid.Add(
            plot_tandem_line_unlabelled_colorBtn, (y, 0), wx.GBSpan(
                1, 1,
            ), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT,
        )
        grid.Add(
            self.plot_tandem_line_unlabelled_colorBtn, (y, 1),
            wx.GBSpan(1, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        y = y + 1
        grid.Add(
            plot_tandem_line_labelled_colorBtn, (y, 0), wx.GBSpan(
                1, 1,
            ), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT,
        )
        grid.Add(
            self.plot_tandem_line_labelled_colorBtn, (y, 1),
            wx.GBSpan(1, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL,
        )
        y = y + 1
