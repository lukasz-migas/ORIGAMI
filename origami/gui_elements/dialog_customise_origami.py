...
class DialogCustomiseORIGAMI(Dialog):
    ...
    def make_panel(self):
        ...
        self.origami_method_choice = wx.Choice(
            panel, -1, choices=self.config.origami_acquisition_choices,
            size=(-1, -1),
        )
        ...
        self.origami_scansPerVoltage_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
        ...
        self.origami_startScan_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
            validator=validator('intPos'),
        )
        ...
        self.origami_startVoltage_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
        ...
        self.origami_endVoltage_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
            validator=validator('floatPos'),
        )
        ...
        self.origami_stepVoltage_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
            validator=validator('floatPos'),
        )
        ...
        self.origami_boltzmannOffset_value = wx.TextCtrl(
            panel, -1, '', size=(-1, -1),
            validator=validator('floatPos'),
        )
...
#         grid.Add(self.origami_loadParams, (n,2), wx.GBSpan(1,1), flag=wx.ALIGN_LEFT)
        ...
        n = n + 1
        grid.Add(
            self.origami_applyBtn, (n, 0), wx.GBSpan(1, 1),
            flag=wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL,
        )
        grid.Add(
            self.origami_cancelBtn, (n, 1), wx.GBSpan(1, 1),
            flag=wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL,
        )
    ...
    def on_load_origami_list(self, evt):
        ...
        dlg = wx.FileDialog(
            self, 'Choose a text file:', wildcard='*.csv',
    ...
    def on_toggle_controls(self, evt):
        ...
        if self.config.origami_acquisition == 'Linear':
            ...
            disableList = [
                self.origami_boltzmannOffset_value, self.origami_exponentialIncrement_value,
