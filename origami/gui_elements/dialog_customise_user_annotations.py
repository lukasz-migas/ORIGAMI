...
class DialogCustomiseUserAnnotations(Dialog):
    ...
    def make_panel(self):
        ...
        y = 0
        grid.Add(charge_std_dev, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.charge_std_dev_value, (y, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL)
        y += 1
        ...
        y += 1
        grid.Add(arrow_cap_length_value, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.arrow_cap_length_value, (y, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL)
        y += 1
        grid.Add(arrow_cap_width_value, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        ...
        y += 1
        grid.Add(zoom_y_buffer_check, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.zoom_y_buffer_check, (y, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL)
        y += 1
        grid.Add(zoom_y_buffer, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        ...
        y += 1
        grid.Add(highlight_alpha, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
        grid.Add(self.highlight_alpha_value, (y, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL)
        y += 1
        grid.Add(highlight_width, (y, 0), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT)
