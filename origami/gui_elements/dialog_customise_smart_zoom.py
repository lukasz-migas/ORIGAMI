...
class dialog_customise_smart_zoom(Dialog):
    ...
    def make_panel(self):
        ...
        y = y + 1
        grid.Add(
            smart_zoom_downsampling_method, (y, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        grid.Add(
            self.smart_zoom_downsampling_method, (y, 1), wx.GBSpan(1, 1), flag=wx.EXPAND | wx.ALIGN_CENTER_VERTICAL
        )
        y = y + 1
