...
class MyFrame(wx.Frame):
    ...
    def __init__(self, parent, config, helpInfo, icons, title='ORIGAMI'):
        ...
        self._mgr.AddPane(
            self.panelDocuments, wx.aui.AuiPaneInfo().Left().Caption('Documents')
        ...
        self._mgr.AddPane(
            self.panelPlots, wx.aui.AuiPaneInfo().CenterPane().Caption('Plot')
        ...
        self._mgr.AddPane(
            self.panelMultipleIons, wx.aui.AuiPaneInfo().Right().Caption('Peak list')
        ...
        self._mgr.AddPane(
            self.panelMultipleText, wx.aui.AuiPaneInfo().Right().Caption('Text files')
            .MinSize((300, -1)).GripperTop().BottomDockable(True).TopDockable(False)
        ...
        self._mgr.AddPane(
            self.panelMML, wx.aui.AuiPaneInfo().Right().Caption('Multiple files')
            .MinSize((300, -1)).GripperTop().BottomDockable(True).TopDockable(False)
        ...
        self._mgr.AddPane(
            self.panelLinearDT, wx.aui.AuiPaneInfo().Right().Caption('Linear Drift Cell')
            .MinSize((300, -1)).GripperTop().BottomDockable(True).TopDockable(False)
        ...
        self._mgr.AddPane(
            self.panelCCS, wx.aui.AuiPaneInfo().Right().Caption('CCS calibration')
        ...
        self._mgr.AddPane(
            self.panelParametersEdit, wx.aui.AuiPaneInfo().Right()
    ...
    def make_menubar(self):
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_openDocument,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_origami_masslynx_raw,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_multiple_origami_masslynx_raw,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_addNewManualDoc,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_multiple_masslynx_raw,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_fileMenu_thermoRAW,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_addNewOverlayDoc,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_addNewInteractiveDoc,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_text_MS,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_text_2D,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_multiple_text_2D,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_load_clipboard_spectrum,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_saveDocument,
        ...
        menuFile.AppendItem(
            makeMenuItem(
                parent=menuFile, id=ID_saveAllDocuments,
        ...
        menuProcess.AppendItem(
            makeMenuItem(
                parent=menuProcess, id=ID_processSettings_ExtractData,
...
#                                             bitmap=self.icons.iconsLib['process_origami_16']))
        ...
        menuProcess.AppendItem(
            makeMenuItem(
                parent=menuProcess, id=ID_processSettings_MS,
        ...
        menuProcess.AppendItem(
            makeMenuItem(
                parent=menuProcess, id=ID_processSettings_2D,
        ...
        menuProcess.AppendItem(
            makeMenuItem(
                parent=menuProcess, id=ID_processSettings_FindPeaks,
        ...
        menuProcess.AppendItem(
            makeMenuItem(
                parent=menuProcess, id=ID_processSettings_UniDec,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_general_plot,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_plot1D,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_plot2D,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_plot3D,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_colorbar,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_legend,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_rmsd,
                text='Settings: &RMSD',
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_waterfall,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_violin,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_extraSettings_general,
                text='Settings: &Extra',
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_annotPanel_otherSettings,
        ...
        menuPlot.AppendItem(
            makeMenuItem(
                parent=menuPlot, id=ID_unidecPanel_otherSettings,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_clearAllPlots,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_docTree_compareMS,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_saveAsInteractive,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_windowMaximize,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_windowMinimize,
        ...
        menuView.AppendItem(
            makeMenuItem(
                parent=menuView, id=ID_windowFullscreen,
        ...
        menuWidgets.AppendItem(
            makeMenuItem(
                parent=menuWidgets, id=ID_docTree_plugin_UVPD,
                text='Open UVPD processing window...',
                bitmap=None,
            ),
        )
        menuWidgets.AppendItem(
            makeMenuItem(
                parent=menuWidgets, id=ID_docTree_plugin_MSMS,
                text='Open MS/MS window...',
                bitmap=None,
            ),
        )
        menuWidgets.AppendItem(
            makeMenuItem(
                parent=menuWidgets, id=ID_docTree_compareMS,
...
#                                               bitmap=None))
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_saveConfig,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_saveAsConfig,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_openConfig,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_openAsConfig,
                text='Import configuration XML file from...',
                bitmap=None,
            ),
        )
        menuConfig.AppendSeparator()
        self.loadCCSAtStart = menuConfig.Append(
            ID_importAtStart_CCS, 'Load at start',
            kind=wx.ITEM_CHECK,
        )
        self.loadCCSAtStart.Check(self.config.loadCCSAtStart)
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_openCCScalibrationDatabse,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_selectCalibrant,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_importExportSettings_peaklist,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_importExportSettings_image,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_importExportSettings_file,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_check_Driftscope,
        ...
        menuConfig.AppendItem(
            makeMenuItem(
                parent=menuConfig, id=ID_setDriftScopeDir,
        ...
        otherSoftwareMenu.AppendItem(
            makeMenuItem(
                parent=otherSoftwareMenu, id=ID_help_UniDecInfo,
...
#         otherSoftwareMenu.Append(ID_open1DIMSFile, 'About CIDER...')
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_dataLoading,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_dataExtraction,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_UniDec,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_ORIGAMI,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_multipleFiles,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_overlay,
...
#                                               bitmap=self.icons.iconsLib['panel_ccs_16']))
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_Interactive,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_annotatingMassSpectra,
        ...
        helpPagesMenu.AppendItem(
            makeMenuItem(
                parent=helpPagesMenu, id=ID_help_page_OtherData,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpGuide,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpGuideLocal,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpYoutube,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpNewVersion,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpCite,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpNewFeatures,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_helpReportBugs,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_CHECK_VERSION,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_WHATS_NEW,
        ...
        menuHelp.AppendItem(
            makeMenuItem(
                parent=menuHelp, id=ID_SHOW_ABOUT,
        ...
        self.Bind(
            wx.EVT_MENU, self.data_handling.on_open_multiple_MassLynx_raw_fcn,
        ...
        self.Bind(
            wx.EVT_MENU, self.data_handling.on_open_MassLynx_raw_MS_only_fcn,
...
#         self.Bind(wx.EVT_MENU, self.onProcessParameters, id=ID_processSettings_ORIGAMI)
        ...
        # UTILITIES
        self.Bind(
            wx.EVT_MENU, self.panelDocuments.documents.on_process_UVPD,
            id=ID_docTree_plugin_UVPD,
        )
        self.Bind(
            wx.EVT_MENU, self.panelDocuments.documents.on_open_MSMS_viewer,
...
#         self.Bind(wx.EVT_MENU, self.onToolbarPosition, id=ID_toolbar_right)
    ...
    def on_import_configuration_file(self, evt, onStart=False):
        ...
        if not onStart:
            if evt.GetId() == ID_openConfig:
                ...
                dlg = wx.FileDialog(
                    self, 'Open Configuration File', wildcard='*.xml',
    ...
    def on_export_configuration_file(self, evt, verbose=True):
        ...
        if evtID == ID_saveConfig:
            ...
            dlg = wx.FileDialog(
                self, 'Save As Configuration File', wildcard='*.xml',
    ...
    def on_check_ORIGAMI_version(self, evt=None):
        ...
        try:
            ...
            self.presenter.onThreading(
                None, ('Could not check version number', 4),
                action='updateStatusbar',
            )
            logger.error(e)
...
#             return
        ...
        try:
            self.presenter.onThreading(
                None, ('Opening local documentation in your browser...', 4),
                action='updateStatusbar',
            )
            webbrowser.open(link, autoraise=1)
        except Exception:
    ...
    def onWindowFullscreen(self, evt):
        ...
        self.ShowFullScreen(
            self._fullscreen, style=wx.FULLSCREEN_ALL & ~
    ...
    def on_open_source_menu(self, evt):
        ...
        menu.AppendItem(
            makeMenuItem(
                parent=menu, id=ID_fileMenu_MGF,
        ...
        menu.AppendItem(
            makeMenuItem(
                parent=menu, id=ID_fileMenu_mzML,
    ...
    def on_toggle_panel(self, evt, check=None):
        ...
        if evtID is not None:
            if evtID == ID_window_documentList:
                ...
                for panel in [
                    self.panelDocuments, self.panelMML,
                    self.panelMultipleIons, self.panelMultipleText,
                    self.panelCCS, self.panelLinearDT,
                ]:
...
#             kwargs = {'window': 'ORIGAMI'}
        ...
        try:
            ...
            self.panelProcessData = panelProcessData(
                self,
                self.presenter,
                self.config,
                self.icons,
    ...
    def onSequenceEditor(self, evt):
        self.panelSequenceAnalysis = panelSequenceAnalysis(
            self,
            self.presenter,
            self.config,
            self.icons,
...
#             return
    ...
    def onDocumentRecent(self, evt):
        ...
        # get index
        indexes = {
            ID_documentRecent0: 0, ID_documentRecent1: 1, ID_documentRecent2: 2,
    ...
    def on_setup_driftscope(self, evt):
        ...
        """
        dlg = wx.DirDialog(
            self.view, r'Choose Driftscope path. Usually at C:\DriftScope\lib',
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            self.onThreading(
                None, (
                    'Driftscope path was set to {}'.format(
                        self.config.driftscopePath,
                    ), 4,
                ), action='updateStatusbar',
            )
