...
class PanelPlots(wx.Panel):
    ...
    #         if key.split(" ")[0] != "MW:":
    #             continue
    #         if num >= plt_kwargs["unidec_panel_plot_individual_line_max_shown"]:
    #             continue
    #         num += 1
    #
    #     # get color list
    ...
    #             xval, yval, color=color, marker=marker, size=plt_kwargs["unidec_panel_plot_mw_markers_size"], label=key, test_xvals=True
    #         )
    #         num += 1
    #
    ...
    #
    #     # modify legend
    #     if len(legend_text) - 1 > plt_kwargs["unidec_panel_plot_individual_line_max_shown"]:
    #         msg = (
    #             "Only showing {} out of {} items.".format(plt_kwargs["unidec_panel_plot_individual_line_max_shown"], len(legend_text) - 1)
    ...
    #     # Add legend
    #     if len(legend_text) >= plt_kwargs["unidec_panel_plot_individual_line_max_shown"]:
    #         legend_text = legend_text[: plt_kwargs["unidec_panel_plot_individual_line_max_shown"]]
    #
    #     plot_obj.plot_1D_add_legend(legend_text, **plt_kwargs)
    #     plot_obj.repaint()
    #
