...
class panelDocumentInfo(wx.MiniFrame):
    ...
    def __init__(self, parent, presenter, config, icons, document, **kwargs):
        wx.MiniFrame.__init__(self, parent, -1, "Document Information", size=(400, 200), style=wx.DEFAULT_FRAME_STYLE)
    ...
    def make_toolbar(self):
        ...
        self.summary_butt = wx.BitmapButton(
            ...
            self.icons.iconsLib["documentTwo16"],
        ...
        self.spectrum_butt = wx.BitmapButton(
            panel, ID_documentInfoSpectrum, self.icons.iconsLib["ms16"], size=(toolbar_toolsize), style=wx.BORDER_NONE
        )
        ...
        self.plotIMS_butt = wx.BitmapButton(
            panel,
            ID_documentInfoPlotIMS,
            self.icons.iconsLib["plotIMS16"],
            size=(toolbar_toolsize),
            style=wx.BORDER_NONE,
        )
        ...
        self.notes_butt = wx.BitmapButton(
            ...
            self.icons.iconsLib["document16"],
            size=(toolbar_toolsize),
            style=wx.BORDER_NONE,
        )
    ...
    def makeNotesPanel(self):
        ...
        # pack elements
        main_sizer = wx.BoxSizer(wx.VERTICAL)
        main_sizer.Add(self.notes_value, 1, wx.EXPAND | wx.ALIGN_CENTER | wx.ALL, PANEL_SPACE_MAIN)
    ...
    def makeSpectrumPanel(self):
        ...
        self.selectBtn = wx.Button(panel, ID_selectProtein, "...", wx.DefaultPosition, wx.Size(25, -1), 0)
        ...
        self.polarity_choice = wx.Choice(panel, -1, choices=["Positive", "Negative", "Undefined"], size=(180, -1))
    ...
    def makeIMS2DPanel(self):
        ...
        self.labelsX_value = wx.Choice(panel, -1, choices=self.config.labelsXChoices, size=(180, -1))
        ...
        self.labelsY_value = wx.Choice(panel, -1, choices=self.config.labelsYChoices, size=(180, -1))
    ...
    def makeCCSCalibrationPanel(self):
        ...
        self.calibrants_value = wx.TextCtrl(panel, -1, "", size=(180, 100), style=wx.TE_WORDWRAP | wx.TE_MULTILINE)
        ...
        self.slopeLinear_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)

        self.slopePower_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)

        intercept_label = wx.StaticText(panel, -1, "Intercept:")
        self.interceptLinear_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)
        self.interceptPower_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)

        r2_label = wx.StaticText(panel, -1, "R²:")
        self.r2Linear_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)
        self.r2Power_value = wx.TextCtrl(panel, -1, "", size=(90, -1), style=wx.TE_READONLY)
    ...
    def on_apply(self, evt):
        ...
        if (
            ...
            and hasattr(self, "labelsX_check")
            and hasattr(self, "labelsY_check")
        ):
            ...
            if "defaultY" not in data:
                data["defaultY"] = {"ylabels": data["ylabels"], "yvals": data["yvals"]}
    ...
    def onChangeDocPath(self, evt):
        dlg = wx.DirDialog(self.parent, "Choose new path to the document file", style=wx.DD_DEFAULT_STYLE)
