...
class panelProcessData(wx.MiniFrame):
    ...
    def __init__(self, parent, presenter, config, icons, **kwargs):
        ...
        self.windowSizes = {
            "Extract": (470, 390),
            "ORIGAMI": (412, 337),
            "Mass spectrum": (412, 640),
            "2D": (412, 268),
            "Peak fitting": (412, 555),
            "UniDec": (400, 785),
        }
        ...
        if kwargs.get("processKwargs", None) != {}:
            self.onUpdateKwargs(data_type=kwargs["processKwargs"]["update_mode"], **kwargs["processKwargs"])
        else:
            self.document = {}
            self.dataset = {}
            self.ionName = {}
    ...
    def make_gui(self):
        ...
        self.mainBook.AddPage(self.make_panel_UniDec(self.parameters_unidec), "UniDec", False)
    ...
    def make_panel_UniDec(self, panel):
        ...
        self.unidec_load = wx.Button(
            panel, ID_processSettings_loadDataUniDec, "Initilise UniDec", size=BTN_SIZE, name="load_data_unidec"
        )
        self.unidec_preprocess = wx.Button(
            panel, ID_processSettings_preprocessUniDec, "Pre-process", size=BTN_SIZE, name="preprocess_unidec"
        )
        ...
        n = 0
        preprocess_grid.Add(
            unidec_ms_min_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        preprocess_grid.Add(self.unidec_mzStart_value, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        preprocess_grid.Add(
            unidec_ms_max_label, (n, 2), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        preprocess_grid.Add(self.unidec_mzEnd_value, (n, 3), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        n = n + 1
        preprocess_grid.Add(
            unidec_ms_binsize_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        n = n + 1
        preprocess_grid.Add(
            unidec_ms_accelerationV_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        preprocess_grid.Add(self.unidec_accelerationV_value, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        n = n + 1
        preprocess_grid.Add(
            unidec_linearization_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        self.unidec_runUnidec = wx.Button(
            panel, ID_processSettings_runUniDec, "Run UniDec", size=BTN_SIZE, name="run_unidec"
        )
        ...
        self.unidec_detectPeaks = wx.Button(
            panel, ID_processSettings_pickPeaksUniDec, "Detect peaks", size=BTN_SIZE, name="pick_peaks_unidec"
        )
        ...
        n = n + 1
        peak_grid.Add(
            unidec_peak_threshold_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        n = n + 1
        peak_grid.Add(
            unidec_peak_separation_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        peak_grid.Add(self.unidec_lineSeparation_value, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL)
        n = n + 1
        peak_grid.Add(
            individualComponents_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        self.unidec_autorun = wx.Button(
            panel, ID_processSettings_autoUniDec, "Autorun UniDec", size=(-1, 22), name="auto_unidec"
        )
        ...
        self.unidec_info = wx.BitmapButton(
            panel,
            ID_processSettings_UniDec_info,
        ...
        self.unidec_weightList_choice = wx.ComboBox(
            panel, ID_processSettings_showZUniDec, choices=[], size=(150, -1), style=wx.CB_READONLY, name="ChargeStates"
        )
        ...
        n = 0
        plotting_grid.Add(
            unidec_plotting_weights_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        plotting_grid.Add(
            self.unidec_weightList_choice, (n, 1), wx.GBSpan(1, 2), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        plotting_grid.Add(
            self.unidec_weightList_sort, (n, 3), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        n = n + 1
        plotting_grid.Add(
            unidec_plotting_adduct_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        plotting_grid.Add(
            self.unidec_adductMW_choice, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        plotting_grid.Add(
            self.unidec_restoreAll_Btn, (n, 2), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        n = n + 1
        plotting_grid.Add(
        ...
        plotting_grid.Add(
            self.unidec_chargeStates_Btn, (n, 2), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        n = n + 1
        plotting_grid.Add(
            unidec_charges_offset_label, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        plotting_grid.Add(
            self.unidec_charges_offset_value, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        plotting_grid.Add(
            self.unidec_isolateCharges_Btn, (n, 2), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_RIGHT
        )
        ...
        self.unidec_maxIters_value = wx.TextCtrl(panel, -1, "", size=TEXTCTRL_SIZE, validator=validator("intPos"))
        ...
        self.unidec_maxShownLines_value = wx.TextCtrl(panel, -1, "", size=TEXTCTRL_SIZE, validator=validator("intPos"))
        ...
        other_grid.Add(
            self.unidec_maxShownLines_value, (n, 3), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.EXPAND
        )
        n = n + 1
        other_grid.Add(
            self.unidec_customise_Btn,
            (n, 0),
            wx.GBSpan(1, 4),
        ...
        n = 0
        button_grid.Add(
            self.unidec_autorun, (n, 0), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL
        )
        button_grid.Add(
            self.unidec_runAll, (n, 1), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL
        )
        button_grid.Add(
            self.unidec_cancelBtn, (n, 2), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL
        )
        button_grid.Add(
            self.unidec_replot_Btn, (n, 3), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL
        )
        button_grid.Add(
            self.unidec_info, (n, 4), wx.GBSpan(1, 1), flag=wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL
        )
            ...
            if plot in ["all", "Fitted", "Processed"]:
                ...
                try:
                    self.presenter.view.panelPlots.on_plot_unidec_MS_v_Fit(
                        unidec_eng_data=None, replot=data["Fitted"], **kwargs
                    )
                except Exception:
                    try:
                        self.presenter.view.panelPlots.on_plot_unidec_MS(
                            unidec_eng_data=None, replot=data["Processed"], **kwargs
                        )
                    except Exception:
                        pass
            ...
            if plot in ["all", "MW distribution"]:
                try:
                    self.presenter.view.panelPlots.on_plot_unidec_mwDistribution(
                        unidec_eng_data=None, replot=data["MW distribution"], **kwargs
                    )
                except Exception:
                    pass
            ...
            if plot in ["all", "m/z vs Charge"]:
                try:
                    self.presenter.view.panelPlots.on_plot_unidec_mzGrid(
                        unidec_eng_data=None, replot=data["m/z vs Charge"], **kwargs
                    )
                except Exception:
                    pass
                ...
                try:
                    ...
                    try:
                        self.presenter.view.panelPlots.on_plot_unidec_MW_add_markers(
                            data["m/z with isolated species"], data["MW distribution"], **kwargs
                        )
                    except Exception:
                        pass
                except Exception:
            ...
            if plot in ["all", "MW vs Charge"]:
                try:
                    self.presenter.view.panelPlots.on_plot_unidec_MW_v_Charge(
                        unidec_eng_data=None, replot=data["MW vs Charge"], **kwargs
                    )
                except Exception:
                    pass
            ...
            if plot in ["all", "Barchart"]:
                try:
                    self.presenter.view.panelPlots.on_plot_unidec_barChart(
                        unidec_eng_data=None, replot=data["Barchart"], **kwargs
                    )
                except Exception:
                    pass
    ...
    def openWidthTool(self, evt):
        try:
            ...
            DialogBox(exceptionTitle="Error", exceptionMsg="Please initilise and process data first!", type="Error")
            return
    ...
    def on_sort_unidec_MW(self, evt):
        ...
        _mass_list_sort = natsorted(_mass_list_sort, key=itemgetter(self._unidec_sort_column), reverse=True)
