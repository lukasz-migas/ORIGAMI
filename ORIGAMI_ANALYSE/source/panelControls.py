...
# 		plot1DMainSizer = self.plot1DSubPanel()
		...
		n = 0
# 		mainGrid.Add(extractMainSizer, (n,0))
		n = n + 1
		mainGrid.Add(plot2DMainSizer, (n,0))
		n = n + 1
		mainGrid.Add(plotComparisonSubPanel, (n,0))
...
# 		self.colorbarMinValue_value.Bind(wx.EVT_TEXT, self.exportToConfig)
# 		self.colorbarMaxValue_value.Bind(wx.EVT_TEXT, self.exportToConfig)
# 		self.colorbarPointsValue_value.Bind(wx.EVT_TEXT, self.exportToConfig)
...
# 		# 		self.colorbarTgl = wx.ToggleButton(self.notebookSettings_paneML, wx.ID_ANY,
# 		#                                 			'Off', wx.DefaultPosition, 
# 		#                               	    		wx.Size( 40,-1 ),
# 		#                                	     	   style=wx.ALIGN_CENTER_VERTICAL)
# 		#        	self.colorbarTgl.SetFont(wx.Font(10, wx.DEFAULT, wx.NORMAL, wx.BOLD))
# 		#     	self.colorbarTgl.SetForegroundColour(wx.RED)
# 		 	
# 	 	self.colorbarSettingsBtn = wx.BitmapButton(self.notebookSettings_paneML,
# 											   ID_extraSettings_colorbar,
# 											   self.icons.iconsLib['settings16_2'],
# 											   size=(26, 26),
# 											   style=wx.BORDER_DEFAULT | wx.ALIGN_CENTER_VERTICAL)
# 	 	self.colorbarSettingsBtn.Bind(wx.EVT_BUTTON, self.parent.onEditParameters)
		...
		# 		
		# 		cbar_min_label = makeStaticText(self.notebookSettings_paneML, u"Low")
		# 		self.colorbarMinValue_value = wx.TextCtrl(self.notebookSettings_paneML, wx.ID_ANY, 
		# 											   	  value=str(self.config.colorbarRange[0]),
		# 											   	  size=(60,-1))
		# 		
		# 		cbar_max_label = makeStaticText(self.notebookSettings_paneML, u"High")
		# 		self.colorbarMaxValue_value = wx.TextCtrl(self.notebookSettings_paneML, wx.ID_ANY, 
		# 											   value=str(self.config.colorbarRange[1]),
		# 											   size=(60,-1))
		# 		
		# 		cbar_points_label = makeStaticText(self.notebookSettings_paneML, u"Points")
		# 		self.colorbarPointsValue_value = wx.SpinCtrlDouble(self.notebookSettings_paneML, wx.ID_ANY, 
		# 											   value=str(self.config.colorbarMinPoints),
		# 											   size=(60,-1))
		
		# 		wx.Button( self.notebookSettings_paneML, 
		# 											ID_extraSettings_colorbar, u"...", wx.DefaultPosition, 
		# 											wx.Size( 70,-1 ), 0 )
...
# 		gridPlot2D.Add(self.colorbarTgl, wx.GBPosition(8, 1), wx.GBSpan(1, 1), wx.ALIGN_CENTER_VERTICAL, 2)
...
# 		# 					wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT,2)
# 		# 		
# 		# 		gridPlot2D.Add(cbar_min_label, wx.GBPosition(9,0), wx.GBSpan(1,2), wx.ALIGN_LEFT, 2)
# 		# 		gridPlot2D.Add(self.colorbarMinValue_value, wx.GBPosition(10,0), wx.GBSpan(1,2), 
# 		# 					wx.ALIGN_CENTER_VERTICAL,2)
# 		# 		gridPlot2D.Add(cbar_max_label, wx.GBPosition(9,2), wx.GBSpan(1,2), wx.ALIGN_LEFT, 2)
# 		# 		gridPlot2D.Add(self.colorbarMaxValue_value, wx.GBPosition(10,2), wx.GBSpan(1,2), 
# 		# 					wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT,2)
# 		# 		gridPlot2D.Add(cbar_points_label, wx.GBPosition(9,4), wx.GBSpan(1,4), wx.ALIGN_LEFT, 2)
# 		# 		gridPlot2D.Add(self.colorbarPointsValue_value, wx.GBPosition(10,4), wx.GBSpan(1,2), 
# 		# 					wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT,2)
# 		
# 		gridPlot2D.Add(self.colorbarSettingsBtn, wx.GBPosition(8, 2), wx.GBSpan(1, 1),
...
# 	def onUpdateColorbarLimits(self, evt):
# 		
# 		self.importEvent = True
# # 		self.colorbarMinValue_value.SetValue(num2str(self.config.colorbarRange[0]))
# # 		self.colorbarMaxValue_value.SetValue(num2str(self.config.colorbarRange[1]))
# 		self.importEvent = False
# 		
# 	def OnColorbarToggle(self, event):
# 		
# # 		enableDisableList = [self.colorbarPad_value,
...
# 		self.config.origami_acquisition = self.comboAcqTypeSelect.GetValue()
...
# 		self.iStartVoltage.SetValue(str(self.config.origami_startVoltage))
# 		self.iEndVoltage.SetValue(str(self.config.origami_endVoltage))
# 		self.iStepVoltage.SetValue(str(self.config.origami_stepVoltage))
# 		self.iStartScan.SetValue(str(self.config.origami_startScan))
# 		self.iSPV.SetValue(str(self.config.origami_spv))
# 		self.iExpPercentage.SetValue(str(self.config.origami_exponentialPercentage))
# 		self.iExpIncrement.SetValue(str(self.config.origami_exponentialIncrement))
# 		self.iFitScale.SetValue(str(self.config.origami_boltzmannOffset))
# 		self.comboAcqTypeSelect.SetValue(self.config.origami_acquisition)
# 		
...
# 		# === ORIGAMI PARAMETERS === #
# 		self.config.origami_startVoltage = str2num(self.iStartVoltage.GetValue())
# 		self.config.origami_endVoltage = str2num(self.iEndVoltage.GetValue())
# 		self.config.origami_stepVoltage = str2num(self.iStepVoltage.GetValue())
# 		self.config.origami_startScan = str2int(self.iStartScan.GetValue())
# 		self.config.origami_spv = str2int(self.iSPV.GetValue())
# 		self.config.origami_exponentialPercentage = str2num(self.iExpPercentage.GetValue())
# 		self.config.origami_exponentialIncrement = str2num(self.iExpIncrement.GetValue())
# 		self.config.origami_boltzmannOffset = str2num(self.iFitScale.GetValue())
# 		self.config.origami_acquisition = self.comboAcqTypeSelect.GetValue()
# 		
...
# # 		self.config.colorbarRange = [str2num(self.colorbarMinValue_value.GetValue()),
# # 									 str2num(self.colorbarMaxValue_value.GetValue())]
# # 		self.config.colorbarMinPoints = str2int(self.colorbarPointsValue_value.GetValue())
# 		
# 		# === EXPORT PARAMETERS === #
