...
class panelParametersEdit(wx.MiniFrame):
    ...
    def __init__(self, parent, presenter, config, icons, **kwargs):
        wx.MiniFrame.__init__(self, parent, -1, 'Plot parameters', 
                              size=(500, 200), style=wx.DEFAULT_FRAME_STYLE)
...
#         self.Iconize()
    ...
    def makeGUI(self):
        ...
        # plot sizes
        self.settings_axesSizes =  wx.Panel(self.mainBook, wx.ID_ANY, wx.DefaultPosition,
                                           wx.DefaultSize, wx.TAB_TRAVERSAL)
        self.mainBook.AddPage(self.makePanelGeneral(self.settings_axesSizes), 
                              u"General", False)
...
########
    ...
    def makePanelRMSD(self, panel):
        ...
        grid = wx.GridBagSizer(2, 2)
        y = 0
        grid.Add(rmsd_box_sizer, (y,0), wx.GBSpan(1,5), flag=wx.EXPAND|wx.ALIGN_LEFT)
        y = y+1
        grid.Add(rmsf_box_sizer, (y,0), wx.GBSpan(1,5), flag=wx.EXPAND|wx.ALIGN_LEFT)
        y = y+1
        grid.Add(rmsd_matrix_box_sizer, (y,0), wx.GBSpan(1,5), flag=wx.EXPAND|wx.ALIGN_LEFT)
    ...
    def makePanelWaterfall(self, panel):
        ...
        self.waterfall_useColormap_check.Bind(wx.EVT_CHECKBOX, self.onUpdate2D)
    ...
    def makeLegendPanel(self, panel):
        ...
        # Replot button
        self.plotLegendBtn = wx.Button(panel, wx.ID_ANY,
                                            u"Plot", wx.DefaultPosition, 
                                            wx.Size( -1, -1 ), 0 )
        self.plotLegendBtn.Bind(wx.EVT_BUTTON, self.onReplot2D)
        ...
        grid.Add(horizontal_line, (y,0), wx.GBSpan(1,3), flag=wx.EXPAND)
        y = y+1
        grid.Add(self.plotLegendBtn, (y,1), flag=wx.ALIGN_CENTER_VERTICAL)
    ...
    def make1DparametersPanel(self, panel):
        ...
        self.plot1D_axisOnOff_check = makeCheckbox(panel, u"")
        ...
        self.plot1D_axisOnOff_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        plot1D_spines_label = wx.StaticText(panel, -1, "Line:")
        self.plot1D_leftSpines_check = makeCheckbox(panel, u"Left")
        ...
        self.plot1D_leftSpines_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_rightSpines_check = makeCheckbox(panel, u"Right")
        ...
        self.plot1D_rightSpines_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_topSpines_check = makeCheckbox(panel, u"Top")
        ...
        self.plot1D_bottomSpines_check = makeCheckbox(panel, u"Bottom")
        ...
        self.plot1D_bottomSpines_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        plot1D_ticks_label = wx.StaticText(panel, -1, "Ticks:")
        self.plot1D_leftTicks_check = makeCheckbox(panel, u"Left")
        ...
        self.plot1D_leftTicks_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_rightTicks_check = makeCheckbox(panel, u"Right")
        ...
        self.plot1D_rightTicks_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_topTicks_check = makeCheckbox(panel, u"Top")
        ...
        self.plot1D_topTicks_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_bottomTicks_check = makeCheckbox(panel, u"Bottom")
        ...
        self.plot1D_bottomTicks_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        plot1D_tickLabels_label = wx.StaticText(panel, -1, "Tick labels:")
        self.plot1D_leftTickLabels_check = makeCheckbox(panel, u"Left")
        ...
        self.plot1D_leftTickLabels_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_rightTickLabels_check = makeCheckbox(panel, u"Right")
        ...
        self.plot1D_rightTickLabels_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_topTickLabels_check = makeCheckbox(panel, u"Top")
        ...
        self.plot1D_topTickLabels_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        
        self.plot1D_bottomTickLabels_check = makeCheckbox(panel, u"Bottom")
        ...
        self.plot1D_bottomTickLabels_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        ...
        self.plot1D_padding_value = wx.SpinCtrlDouble(panel, -1, 
                                               ...
                                               min=1, max=100, initial=self.config.labelPad_1D, 
                                               inc=5, size=(90, -1))
        self.plot1D_padding_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onApply_1D)
        self.plot1D_padding_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onUpdate1D)
        ...
        self.plot1D_titleFontSize_value = wx.SpinCtrlDouble(panel, -1, 
                                               ...
                                               min=0, max=32, initial=self.config.titleFontSize_1D, 
                                               inc=1, size=(90, -1))
        self.plot1D_titleFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onApply_1D)
        self.plot1D_titleFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onUpdate1D)

        self.plot1D_titleFontWeight_check = makeCheckbox(panel, u"Bold")
        ...
        self.plot1D_titleFontWeight_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        ...
        self.plot1D_labelFontSize_value = wx.SpinCtrlDouble(panel, -1, 
                                               ...
                                               min=0, max=32, initial=self.config.labelFontSize_1D, 
                                               inc=1, size=(90, -1))
        self.plot1D_labelFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onApply_1D)
        self.plot1D_labelFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onUpdate1D)

        self.plot1D_labelFontWeight_check = makeCheckbox(panel, u"Bold")
        ...
        self.plot1D_labelFontWeight_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        ...
        self.plot1D_tickFontSize_value = wx.SpinCtrlDouble(panel, -1, 
                                               ...
                                               min=0, max=32, initial=self.config.tickFontSize_1D, 
                                               inc=1, size=(90, -1))
        self.plot1D_tickFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onApply_1D)
        self.plot1D_tickFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onUpdate1D)
        
        self.plot1D_tickFontWeight_check = makeCheckbox(panel, u"Bold")
        ...
        self.plot1D_tickFontWeight_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
        ...
        self.plot1D_annotationFontSize_value = wx.SpinCtrlDouble(panel, -1, 
                                               ...
                                               min=0, max=32, initial=self.config.annotationFontSize_1D, 
                                               inc=1, size=(90, -1))
        self.plot1D_annotationFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onApply_1D)
        self.plot1D_annotationFontSize_value.Bind(wx.EVT_SPINCTRLDOUBLE, self.onUpdate1D)
        
        self.plot1D_annotationFontWeight_check = makeCheckbox(panel, u"Bold")
        ...
        self.plot1D_annotationFontWeight_check.Bind(wx.EVT_CHECKBOX, self.onUpdate1D)
...
#         self.onUpdate1D(evt=None)
    ...
    def onApply_2D(self, evt):
        # plot 2D
        self.config.axisOnOff_2D = self.plot2D_axisOnOff_check.GetValue()
        ...
        self.config.labelPad_2D = str2int(self.plot2D_padding_value.GetValue())
        self.config.annotationFontSize_2D = str2num(self.plot2D_annotationFontSize_value.GetValue())
        self.config.annotationFontWeight_2D = self.plot2D_annotationFontWeight_check.GetValue()
        self.config.tickFontSize_2D = str2num(self.plot2D_tickFontSize_value.GetValue())
        self.config.tickFontWeight_2D = self.plot2D_tickFontWeight_check.GetValue()
        self.config.labelFontSize_2D = str2num(self.plot2D_labelFontSize_value.GetValue())
        self.config.labelFontWeight_2D = self.plot2D_labelFontWeight_check.GetValue()
        self.config.titleFontSize_2D = str2num(self.plot2D_titleFontSize_value.GetValue())
        self.config.titleFontWeight_2D = self.plot2D_titleFontWeight_check.GetValue()
        self.config.spines_left_2D = self.plot2D_leftSpines_check.GetValue()
        self.config.spines_right_2D = self.plot2D_rightSpines_check.GetValue()
        self.config.spines_top_2D = self.plot2D_topSpines_check.GetValue()
        self.config.spines_bottom_2D = self.plot2D_bottomSpines_check.GetValue()
        self.config.ticks_left_2D = self.plot2D_leftTicks_check.GetValue()
        self.config.ticks_right_2D = self.plot2D_rightTicks_check.GetValue()
        self.config.ticks_top_2D = self.plot2D_topTicks_check.GetValue()
        self.config.ticks_bottom_2D = self.plot2D_bottomTicks_check.GetValue()
        self.config.tickLabels_left_2D = self.plot2D_leftTickLabels_check.GetValue()
        self.config.tickLabels_right_2D = self.plot2D_rightTickLabels_check.GetValue()
        self.config.tickLabels_top_2D = self.plot2D_topTickLabels_check.GetValue()
        self.config.tickLabels_bottom_2D = self.plot2D_bottomTickLabels_check.GetValue()

        # fire events
        self.onApply(evt=None)
#         self.onUpdate2D(evt=None)
    ...
    def onApply_3D(self, evt):
        ...
        self.config.labelPad_3D = str2int(self.plot3D_padding_value.GetValue())
        self.config.annotationFontSize_3D = str2num(self.plot3D_annotationFontSize_value.GetValue())
        self.config.annotationFontWeight_3D = self.plot3D_annotationFontWeight_check.GetValue()
        self.config.tickFontSize_3D = str2num(self.plot3D_tickFontSize_value.GetValue())
        self.config.tickFontWeight_3D = self.plot3D_tickFontWeight_check.GetValue()
        self.config.labelFontSize_3D = str2num(self.plot3D_labelFontSize_value.GetValue())
        self.config.labelFontWeight_3D = self.plot3D_labelFontWeight_check.GetValue()
        self.config.titleFontSize_3D = str2num(self.plot3D_titleFontSize_value.GetValue())
        self.config.titleFontWeight_3D = self.plot3D_titleFontWeight_check.GetValue()
        if self.plot3D_colorEdgeMarker_check.GetValue():
            self.config.markerEdgeColor_3D = self.config.markerColor_3D
            
        # fire events
#         self.onUpdate3D(evt=None)
    ...
    def onApply(self, evt):
        ...
        self.config.waterfall_useColormap = self.waterfall_useColormap_check.GetValue()
    ...
    def onChangeColour(self, evt):
        ...
        try: self.presenter.view.updatePlots(None)
        except: pass
    ...
    def onEnableDisableFeatures_1D(self, evt):
        enableDisableList = [self.plot1D_topTicks_check, 
                             self.plot1D_topTickLabels_check, 
                             self.plot1D_topSpines_check,
                             self.plot1D_bottomTicks_check, 
                             self.plot1D_bottomTickLabels_check, 
                             self.plot1D_bottomSpines_check,
                             self.plot1D_rightTicks_check, 
                             self.plot1D_rightTickLabels_check, 
                             self.plot1D_rightSpines_check,
                             self.plot1D_leftTicks_check, 
                             self.plot1D_leftTickLabels_check, 
                             self.plot1D_leftSpines_check]
        
        if self.plot1D_axisOnOff_check.GetValue():
    ...
    def onEnableDisableFeatures_2D(self, evt):
        enableDisableList = [self.plot2D_topTicks_check, 
                             self.plot2D_topTickLabels_check, 
                             self.plot2D_topSpines_check,
                             self.plot2D_bottomTicks_check, 
                             self.plot2D_bottomTickLabels_check, 
                             self.plot2D_bottomSpines_check,
                             self.plot2D_rightTicks_check, 
                             self.plot2D_rightTickLabels_check, 
                             self.plot2D_rightSpines_check,
                             self.plot2D_leftTicks_check, 
                             self.plot2D_leftTickLabels_check, 
                             self.plot2D_leftSpines_check]
        
        if self.plot2D_axisOnOff_check.GetValue():
            for item in enableDisableList: item.Enable()
        else:
            for item in enableDisableList: item.Disable()
...
#                              self.colorbarMinValue_value,
#                              self.colorbarMaxValue_value,
#                              self.colorbarPointsValue_value,
#                              self.colorbarRefreshBtn,
    ...
    def onEnableDisableFeatures_waterfall(self, evt):
        ...
        self.config.waterfall_useColormap = self.waterfall_useColormap_check.GetValue()
        if self.config.waterfall_useColormap: 
